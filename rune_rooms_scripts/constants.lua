...
RuneRooms.Constants.RUNE_NAMES = {
	...
	[RuneRooms.Enums.RuneEffect.BERKANO] = "berkano",
	[RuneRooms.Enums.RuneEffect.DAGAZ] = "dagaz",
	[RuneRooms.Enums.RuneEffect.EHWAZ] = "ehwaz",
	[RuneRooms.Enums.RuneEffect.FEHU] = "fehu",
	[RuneRooms.Enums.RuneEffect.GEBO] = "gebo",
	[RuneRooms.Enums.RuneEffect.HAGALAZ] = "hagalaz",
	[RuneRooms.Enums.RuneEffect.INGWAZ] = "ingwaz",
	[RuneRooms.Enums.RuneEffect.JERA] = "jera",
	[RuneRooms.Enums.RuneEffect.KENAZ] = "kenaz",
	[RuneRooms.Enums.RuneEffect.OTHALA] = "othala",
	[RuneRooms.Enums.RuneEffect.PERTHRO] = "perthro",
...
RuneRooms.Constants.RuneNames = {
	[RuneRooms.Enums.Runes.GEBO] = "Gebo",
	[RuneRooms.Enums.Runes.KENAZ] = "Kenaz",
	[RuneRooms.Enums.Runes.FEHU] = "Fehu",
	[RuneRooms.Enums.Runes.OTHALA] = "Othala",
	[RuneRooms.Enums.Runes.SOWILO] = "Sowilo",
...
RuneRooms.Constants.Descriptions = {
	Collectibles = {
		[RuneRooms.Enums.Item.ALGIZ_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.ANSUZ_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.BERKANO_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.DAGAZ_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.EHWAZ_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.FEHU_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.GEBO_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.INGWAZ_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.JERA_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.KENAZ_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.OTHALA_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.PERTHRO_ESSENCE] = {
			en_us = {
		...
		[RuneRooms.Enums.Item.SOWILO_ESSENCE] = {
			en_us = {
	...
	PositiveRuneEffect = {
		[RuneRooms.Enums.RuneEffect.ALGIZ] = {
			en_us = {
				name = "Algiz",
		...
		[RuneRooms.Enums.RuneEffect.BERKANO] = {
			en_us = {
				name = "Berkano",
		...
		[RuneRooms.Enums.RuneEffect.DAGAZ] = {
			en_us = {
				name = "Dagaz",
		...
		[RuneRooms.Enums.RuneEffect.FEHU] = {
			en_us = {
				name = "Fehu",
		...
		[RuneRooms.Enums.RuneEffect.INGWAZ] = {
			en_us = {
				name = "Ingwaz",
		...
		[RuneRooms.Enums.RuneEffect.JERA] = {
			en_us = {
				name = "Jera",
		...
		[RuneRooms.Enums.RuneEffect.KENAZ] = {
			en_us = {
				name = "Kenaz",
		...
		[RuneRooms.Enums.RuneEffect.PERTHRO] = {
			en_us = {
				name = "Perthro",
		...
		[RuneRooms.Enums.RuneEffect.SOWILO] = {
			en_us = {
				name = "Sowilo",
	...
	Runes = {
		...
		[RuneRooms.Enums.Runes.KENAZ] = {
			en_us = {
				name = "Kenaz",
				description = "Poisons all enemies in the room#{{HalfBlackHeart}} +1 Half Black Heart",
			},
			spa = {
				name = "Kenaz",
			...
			ru = {
				name = "Кеназ",
				description = "Отравляет всех врагов в комнате#{{HalfBlackHeart}} +1 половина черного сердца",
			},
		},
